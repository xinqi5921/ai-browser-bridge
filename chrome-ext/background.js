...
async function handleMessage(message) {
    ...
    try {
        ...
        if (type === "browser_navigate")
            result = "Navigated to " + payload.url;
        else if (type === "browser_snapshot")
            result = "Page snapshot";
        else if (type === "browser_click")
            result = "Clicked " + payload.ref;
        else if (type === "browser_type")
            result = "Typed " + payload.text;
